...
<title>Page Not Found — Cow Management</title>
<style>
...
.code{font-size:5rem;font-weight:800;color:#2D6A4F;line-height:1}
...
.btn-sec{background:transparent;color:#2D6A4F;border:1.5px solid #2D6A4F;margin-left:.5rem}
</style>
</head>
<body>
<div class="card">
    ...
    <a href="/home.php" class="btn btn-sec">Home</a>
    <?php endif; ?>
</div>
</body>
</html>
